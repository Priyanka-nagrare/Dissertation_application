...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/version1/dashboard.css" />  <!---This is the CSS stylesheet for styling the HTML across all pages for this website-->
    </head>
    <body>
...
<?php
            ...
            if (isset($_SESSION['student_forename'])) {
                ...
                <li><a href="logout.php?redirectUrl=<?php echo urlencode('/version1/index.php'); ?>" class="nav-item">Logout</a></li><!--if a customer is logged in the nav bar will show the logout option--->
                <?php
            } else {
                // To Display login and register buttons if the customer is not logged in
                ?>
                <li><a href="/version1/login.php?redirectUrl=<?php echo urlencode('/KF7013/content/index.php'); ?>" class="nav-item">LOGIN</a></li><!---A login page that will allow users to log onto and use the website-->
...
<!-- Add similar divs for Goals, Meeting Agendas, Reflections, and Export Data -->
    ...
    <script src="/version1/dashboard.js"></script>
  </body>
</html>