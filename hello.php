...
$customerID = $_SESSION['studentID']; // Get customer ID from session
$query = $conn->prepare("SELECT student_forename, student_surname, student_email, date_of_birth FROM students WHERE studentID = ?");
...
<body>
    <div class="contact-form-section">
        ...
        <form class="account-form">
            ...
            <input type="text" id="forename" name="student_forename" value="<?php echo htmlspecialchars($row['customer_forename']); ?>" readonly>

            <label for="surname">Last Name</label>
            <input type="text" id="surname" name="student_surname" value="<?php echo htmlspecialchars($row['customer_surname']); ?>" readonly>

            <label for="email">Email</label>
            <input type="email" id="email" name="student_email" value="<?php echo htmlspecialchars($row['customer_email']); ?>" readonly>
