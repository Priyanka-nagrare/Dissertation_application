// Description: This file contains the JavaScript code for the task page.
...
// Variable to keep track of the active overlay
let activeOverlay = null;

//** event listeners **//

// Radio buttons to switch between list and board view
...
// open set task overlay on click
...
// opening the status dropdown on click of status select
statusSelect.addEventListener("click", () => {
  statusDropdown.classList.toggle("hide");
});

// set the selected status on click of a status option
...
// close overlay on click of delete task Click-To-Action
